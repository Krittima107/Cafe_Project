...
// --- โค้ดส่วนที่เพิ่มใหม่: ดึงข้อมูลออเดอร์และคำนวณรายได้ ---
...
if (!$total_revenue) {
    $total_revenue = 0; // ถ้ายังไม่มีรายได้ ให้แสดงเป็น 0
}
?>
    ...
    <div class="main-content">
        <div class="container">
            ...
            <div class="dashboard-grid">
                ...
                <div class="stat-card" style="background-color: #e3f2fd; border-color: #2196f3;">
                ...
                <div class="stat-card" style="background-color: #e8f5e9; border-color: #4caf50;">
                    <h3>รายได้รวม</h3>
                    <div class="number" style="color: #4caf50;"><?php echo number_format($total_revenue, 2); ?></div>
            ...
            <div style="margin-top: 20px; border-top: 2px solid var(--color-cream); padding-top: 20px;">
                ...
                <a href="orders.php" class="btn" style="background-color: #ff9800; color: white;">📦
                    ดูคำสั่งซื้อของลูกค้า</a>
