...
<div class="navbar">
    ...
    <div style="display: flex; align-items: center; gap: 15px; flex-wrap: wrap;">
        <?php if (isset($current_user) && $current_user): ?>
            <div
                style="display: flex; align-items: center; gap: 10px; background: rgba(255,255,255,0.15); padding: 5px 15px; border-radius: 30px; border: 1px solid rgba(255,255,255,0.3); white-space: nowrap;">
            ...
            <?php if (isset($is_admin) && $is_admin): ?>
                <a href="<?php echo $path; ?>admin/edit_profile.php"
                    style="background-color: var(--color-brown-light); white-space: nowrap;">✏️ แก้ไขโปรไฟล์</a>
        ...
        <?php else: ?>
            <a href="<?php echo $path; ?>login_user.php"
                style="background-color: var(--color-green); white-space: nowrap;">👤 เข้าสู่ระบบ (User)</a>
            <a href="<?php echo $path; ?>login_admin.php"
                style="background-color: var(--color-brown-dark); white-space: nowrap;">🔒 เข้าสู่ระบบ (Admin)</a>
        <?php endif; ?>
    </div>
</div>